...
| Field | Value |
|---|---|
| Repository | `c_example_algorithms` |
| Language | C (C / CMake) |
| Versao | 1.0 |
| Status | Ativo |
...
Reference implementation of algorithms with documented complexity. This document describes requirements, architecture, and acceptance criteria.
